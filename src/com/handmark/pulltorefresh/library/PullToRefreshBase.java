...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected int right, wrong, none;
	...
	@Override
	public final void onRefreshComplete(int right, int wrong, int none) {
	 ...
	 * 
	 * @param mContext Context to create view with
