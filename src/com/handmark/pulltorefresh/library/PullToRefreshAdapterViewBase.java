...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	...
	/**
	 * Gets whether an com.ihateflyingbugs.vocasilide.indicator graphic should be displayed when the View is in
	...
	public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
		...
		// If we're showing the com.ihateflyingbugs.vocasilide.indicator, check positions...
	...
	/**
	 * Sets whether an com.ihateflyingbugs.vocasilide.indicator graphic should be displayed when the View is in
	 * a state where a Pull-to-Refresh can happen. An example of this state is
	 * when the Adapter View is scrolled to the top and the mode is set to
