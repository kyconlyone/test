...
public class QnAActivity extends Activity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		handler= new Handler();
		et_qna_email = (EditText)findViewById(R.id.et_qna_email);
		et_qna_phone = (EditText)findViewById(R.id.et_qna_phone);
		et_qna_text = (EditText)findViewById(R.id.et_qna_text);
		
		sp_qna_title = (Spinner)findViewById(R.id.spinner1);
		
		bt_qna_submit= (Button)findViewById(R.id.bt_qna_submit);
		pb_qna_splash =  (ProgressBar) findViewById(R.id.pb_qna_splash);
